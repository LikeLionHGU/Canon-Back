...
public class EmailService {
    ...
    public void sendMail(CustomOAuth2UserDTO userDTO,  Long postId){
        ...
        String html = "<!DOCTYPE html>\n" +
                ...
                "        <a href=\"#\" style=\"display: inline-block; background-color: #39007C; color: white; text-decoration: none; padding: 12px 24px; border-radius: 5px; margin: 10px; font-weight: bold; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.2); transition: all 0.3s ease;\">웹사이트</a>\n" +
